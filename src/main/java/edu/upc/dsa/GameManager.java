...
public interface GameManager {
    ...
    public String addUser(String name, String surname, String date, String mail, String password, String profileAvatar) throws EmailAlreadyBeingUsedException, SQLException;
    ...
    public void updateUser(UpdatableUserInformation user) throws UserDoesNotExistException, SQLException;
